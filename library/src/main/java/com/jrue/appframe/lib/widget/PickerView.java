...
public class PickerView extends View {
    ...
    int mColorText = 0x63A8EB;
    int mOtherColorText = 0xECECEC;
    ...
    private void init() {
        ...
        mOtherPaint.setColor(getResources().getColor(R.color.pickerView_faded_color));
    }
    ...
    private void drawOtherText(Canvas canvas, int position, int type) {
        ...
        mOtherPaint.setTextSize(size);
       // mPaint.setAlpha((int) ((mMaxTextAlpha - mMinTextAlpha) * scale + mMinTextAlpha));
        float y = (float) (mViewHeight / 2.0 + type * d);
        Paint.FontMetricsInt fmi = mOtherPaint.getFontMetricsInt();
        float baseline = (float) (y - (fmi.bottom / 2.0 + fmi.top / 2.0));
        canvas.drawText(mDataList.get(mCurrentSelected + type * position),
                (float) (mViewWidth / 2.0), baseline, mOtherPaint);
    }
